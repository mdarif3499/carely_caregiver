  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SignUpController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            title: CommonText(text: "Create New Account", fontSize: 18.sp),
            centerTitle: true,
                    ...
                    child: Column(
                      children: [
                          ...
                          children: [
                            Theme(
                              ...
                              child: Checkbox(
                                ...
                                fillColor:
                                    WidgetStatePropertyAll(AppColors.instance.white50),
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () {
                                          Get.toNamed(
                                              AppRoutes.instance.privacyPolicy);
                                        },
                                    ),
                                  ],
                                ),
                        ...
                        CommonButton(
                          ...
                          buttonColor: controller.termsAndConditions.value
                              ? AppColors.instance.primary
                              : AppColors.instance.dark100,
                          borderColor: controller.termsAndConditions.value
                              ? AppColors.instance.primary
                              : AppColors.instance.dark100,
                          titleText: "Next",
                          buttonHeight: 54.h,
                          ...
                          buttonRadius: 14.r,
                          onTap: controller.termsAndConditions.value &&
