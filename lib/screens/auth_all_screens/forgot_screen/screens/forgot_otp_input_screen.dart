                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          5.height,
                          CommonText(text: "We've Sent a Code to ${AppUtils.maskEmail(controller.emailController.text)}", textColor: const Color(0xFF6A7282)),
                          30.height,
                          Align(
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              style: TextStyle(color: const Color(0xFF333333).withValues(alpha: 0.6), fontSize: 14.sp),
                              children: [
                                TextSpan(
                                  text: "Resend",
                                  style: TextStyle(
